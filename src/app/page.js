                ...
                <ul className="group/list">
                  ...
                  <li className="mb-12">
                    <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                      ...
                      <div className="z-10 sm:order-2 sm:col-span-6">
                        <h3>
                          <a className="inline-flex items-baseline font-medium leading-tight text-theme-primary hover:text-theme-accent focus-visible:text-theme-accent group/link text-base" href="https://richard-daskas.itch.io/neon-harvest" target="_blank" rel="noreferrer" aria-label="Neon-Harvest">
                            <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                            <span>Neon Harvest
                        ...
                        <p className="mt-2 text-sm leading-normal text-theme-muted">
                          A fully functional slot machine prototype built in Unity demonstrating industry-standard 
                          casino game development concepts including virtual reel strip weighting, certified RNG abstraction, 
                          theoretical RTP calculation, and 5-line payline evaluation.
                        </p>
                        <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                          <li className="mr-1.5 mt-2">
                            <div className="flex items-center rounded-full bg-theme-accent px-3 py-1 text-xs font-medium leading-5 text-theme-accent">Unity</div>
                          ...
                          <li className="mr-1.5 mt-2">
                            <div className="flex items-center rounded-full bg-theme-accent px-3 py-1 text-xs font-medium leading-5 text-theme-accent">Casino</div>
                          </li>
                          <li className="mr-1.5 mt-2">
                            <div className="flex items-center rounded-full bg-theme-accent px-3 py-1 text-xs font-medium leading-5 text-theme-accent">Prototype</div>
                          </li>
                        </ul>
                      </div>
                      <img alt="Neon Harvest screenshot" loading="lazy" width="200" height="48" decoding="async" className="rounded border-2 border-theme-primary/10 transition group-hover:border-theme-primary/30 sm:order-1 sm:col-span-2 sm:translate-y-1" style={{color: 'transparent'}} src="/ss_neonharvest.png" />
                    </div>
                  </li>
                  ...
                  <li className="mb-12">
                    <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                      ...
                      <div className="z-10 sm:order-2 sm:col-span-6">
                        <h3>
                          <a className="inline-flex items-baseline font-medium leading-tight text-theme-primary hover:text-theme-accent focus-visible:text-theme-accent group/link text-base" href="https://richard-daskas.itch.io/cascadium" target="_blank" rel="noreferrer" aria-label="Cascadium">
                            <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                            <span>Cascadium
                              <span className="inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-translate-y-1 group-hover/link:translate-x-1 group-focus-visible/link:-translate-y-1 group-focus-visible/link:translate-x-1 motion-reduce:transition-none ml-1 translate-y-px" aria-hidden="true">
                        ...
                        <p className="mt-2 text-sm leading-normal text-theme-muted">
                          Match-3 puzzle game built in 48 hours. Features grid-based match detection, cascade chains, 
                          combo scoring system, polished game feel with particles and screen shake, and responsive 
                          touch/mouse input. Developed to demonstrate rapid prototyping and casual game mechanics.
                        </p>
                        <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                          <li className="mr-1.5 mt-2">
                            <div className="flex items-center rounded-full bg-theme-accent px-3 py-1 text-xs font-medium leading-5 text-theme-accent">Unity</div>
                          ...
                          <li className="mr-1.5 mt-2">
                            <div className="flex items-center rounded-full bg-theme-accent px-3 py-1 text-xs font-medium leading-5 text-theme-accent">Puzzle Mechanics</div>
                          </li>
                          <li className="mr-1.5 mt-2">
                            <div className="flex items-center rounded-full bg-theme-accent px-3 py-1 text-xs font-medium leading-5 text-theme-accent">AI-Assisted</div>
                          </li>
                        </ul>
                      </div>
                      <img alt="Cascadium screenshot" loading="lazy" width="200" height="48" decoding="async" className="rounded border-2 border-theme-primary/10 transition group-hover:border-theme-primary/30 sm:order-1 sm:col-span-2 sm:translate-y-1" style={{color: 'transparent'}} src="/ss_cascadium.png" />
                    </div>
                  </li>
